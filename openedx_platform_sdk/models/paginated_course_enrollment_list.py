...
T = TypeVar("T", bound="PaginatedCourseEnrollmentList")
...
class PaginatedCourseEnrollmentList:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for results_item_data in _results:
            results_item = CourseEnrollment.from_dict(results_item_data)
        ...
        paginated_course_enrollment_list.additional_properties = d
        return paginated_course_enrollment_list
