...
if TYPE_CHECKING:
    from ..models.xblock_actions_type_0 import XblockActionsType0
    from ..models.xblock_fields_type_0 import XblockFieldsType0
    from ..models.xblock_group_access_type_0 import XblockGroupAccessType0
    from ..models.xblock_metadata_type_0 import XblockMetadataType0
    from ..models.xblock_user_partition_info_type_0 import XblockUserPartitionInfoType0


T = TypeVar("T", bound="Xblock")
...
class Xblock:
    ...
    chosen based on ease of discovery, not comprehensiveness.
        ...
        Attributes:
            ...
            data (None | str | Unset):
            metadata (None | Unset | XblockMetadataType0):
            has_changes (bool | None | Unset):
            children (list[Any] | None | Unset):
            fields (None | Unset | XblockFieldsType0):
            ...
            actions (None | Unset | XblockActionsType0):
            explanatory_message (None | str | Unset):
            group_access (None | Unset | XblockGroupAccessType0):
            ...
            user_partition_info (None | Unset | XblockUserPartitionInfoType0):
    ...
    metadata: None | Unset | XblockMetadataType0 = UNSET
    has_changes: bool | None | Unset = UNSET
    children: list[Any] | None | Unset = UNSET
    fields: None | Unset | XblockFieldsType0 = UNSET
    ...
    actions: None | Unset | XblockActionsType0 = UNSET
    explanatory_message: None | str | Unset = UNSET
    group_access: None | Unset | XblockGroupAccessType0 = UNSET
    ...
    user_partition_info: None | Unset | XblockUserPartitionInfoType0 = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.metadata, Unset):
            metadata = UNSET
        elif isinstance(self.metadata, XblockMetadataType0):
        ...
        if isinstance(self.fields, Unset):
            fields = UNSET
        elif isinstance(self.fields, XblockFieldsType0):
        ...
        if isinstance(self.actions, Unset):
            actions = UNSET
        elif isinstance(self.actions, XblockActionsType0):
        ...
        if isinstance(self.group_access, Unset):
            group_access = UNSET
        elif isinstance(self.group_access, XblockGroupAccessType0):
        ...
        elif isinstance(self.user_partition_info, XblockUserPartitionInfoType0):
    ...
    def to_multipart(self) -> types.RequestFiles:
        ...
        if not isinstance(self.metadata, Unset):
            if isinstance(self.metadata, XblockMetadataType0):
        ...
        if not isinstance(self.fields, Unset):
            if isinstance(self.fields, XblockFieldsType0):
        ...
        if not isinstance(self.actions, Unset):
            if isinstance(self.actions, XblockActionsType0):
        ...
        if not isinstance(self.group_access, Unset):
            if isinstance(self.group_access, XblockGroupAccessType0):
                files.append(
        ...
        if not isinstance(self.user_partition_info, Unset):
            if isinstance(self.user_partition_info, XblockUserPartitionInfoType0):
                files.append(
                    (
                        "user_partition_info",
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_metadata(data: object) -> None | Unset | XblockMetadataType0:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                metadata_type_0 = XblockMetadataType0.from_dict(data)

                return metadata_type_0
            except (TypeError, ValueError, AttributeError, KeyError):
                pass
            return cast(None | Unset | XblockMetadataType0, data)
        ...
        def _parse_fields(data: object) -> None | Unset | XblockFieldsType0:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                fields_type_0 = XblockFieldsType0.from_dict(data)

                return fields_type_0
            except (TypeError, ValueError, AttributeError, KeyError):
                pass
            return cast(None | Unset | XblockFieldsType0, data)
        ...
        def _parse_actions(data: object) -> None | Unset | XblockActionsType0:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                actions_type_0 = XblockActionsType0.from_dict(data)

                return actions_type_0
            except (TypeError, ValueError, AttributeError, KeyError):
                pass
            return cast(None | Unset | XblockActionsType0, data)
        ...
        def _parse_group_access(data: object) -> None | Unset | XblockGroupAccessType0:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                group_access_type_0 = XblockGroupAccessType0.from_dict(data)

                return group_access_type_0
            except (TypeError, ValueError, AttributeError, KeyError):
                pass
            return cast(None | Unset | XblockGroupAccessType0, data)
        ...
        def _parse_user_partition_info(data: object) -> None | Unset | XblockUserPartitionInfoType0:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                user_partition_info_type_0 = XblockUserPartitionInfoType0.from_dict(data)

                return user_partition_info_type_0
            except (TypeError, ValueError, AttributeError, KeyError):
                pass
            return cast(None | Unset | XblockUserPartitionInfoType0, data)
        ...
        xblock.additional_properties = d
        return xblock
