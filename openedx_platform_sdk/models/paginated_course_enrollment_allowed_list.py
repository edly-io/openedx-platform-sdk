...
T = TypeVar("T", bound="PaginatedCourseEnrollmentAllowedList")


@_attrs_define
class PaginatedCourseEnrollmentAllowedList:
    """
    Attributes:
        count (int):  Example: 123.
        results (list[CourseEnrollmentAllowed]):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for results_item_data in _results:
            results_item = CourseEnrollmentAllowed.from_dict(results_item_data)
        ...
        paginated_course_enrollment_allowed_list = cls(
            count=count,
            results=results,
            next_=next_,
            previous=previous,
        ...
        paginated_course_enrollment_allowed_list.additional_properties = d
        return paginated_course_enrollment_allowed_list
